...
{
       0,     0,     3,     5,     9,    11,    14,    19,    25,    26
};

/* YYRHS -- A `-1'-separated list of the rules' RHS. */
static const yysigned_char yyrhs[] =
{
       9,     0,    -1,    10,    -1,     5,    11,     6,    -1,    12,
      -1,    10,    11,    -1,    10,     7,     3,    11,    -1,    10,
       3,     7,     3,    11,    -1,    -1,     4,    -1
};
...
{
  "$end", "error", "$undefined", "FLOAT", "NAME", "'('", "')'", "':'",
  "$accept", "top", "tree", "edge_list", "leaf", 0
};
#endif
...
{
      11,     9,     1,     2,     8,    10,     1,     2,    16,    17,
      13,    12,    14,    15,     4
};

static const unsigned char yycheck[] =
{
       6,     3,     4,     5,     0,     7,     4,     5,    14,    15,
       7,     6,     3,     3,     0
};
